...
div.Item { box-sizing: border-box; margin: 10px; }
div.Item:hover {
  ...
  <tr class="RowContainer">
    <td class="ItemContainer">
		<div class="Item">
			...
			<div class="Stimulus">
				<img src="https://raw.githubusercontent.com/lukavdplas/adjective-order/main/experiment/acceptability_with_semantic/materials/images/tv_01.jpg" style="max-width:90%"><br>
